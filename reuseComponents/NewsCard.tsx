  ...
  return (
    <div className="flex flex-col lg:flex-row items-start gap-1 lg:gap-4 rounded-md p-4">
      ...
      <div className="flex flex-col justify-between h-auto lg:h-[177px]">
        ...
        {href ? (
          <Link href={href} className="text-[#61213C] text-sm font-medium flex items-center gap-1 mt-auto hover:text-[#7D2B4D] transition-colors">
            {buttonText}
            <Image
              src="/arrowd.svg"
              alt="arrow"
          ...
          <button 
            onClick={onClick}
            className="text-[#61213C] text-sm font-medium flex items-center gap-1 mt-auto hover:text-[#7D2B4D] transition-colors"
          >
            {buttonText}
            <Image
              src="/arrowd.svg"
